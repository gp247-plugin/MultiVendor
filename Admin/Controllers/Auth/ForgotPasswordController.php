...
class ForgotPasswordController extends RootVendorController
{
    /*
    |--------------------------------------------------------------------------
    ...
    public function getForgot()
    {
        ...
        $data = [
            'title'       => gp247_language_render('multi_vendor.password_forgot'),
            'breadcrumbs' => [
                ['url'    => '', 'title' => gp247_language_render('multi_vendor.password_forgot')],
            ],
        ];
        return view($this->plugin->appPath.'::Admin.auth.forgot')
            ->with($data);
    }
